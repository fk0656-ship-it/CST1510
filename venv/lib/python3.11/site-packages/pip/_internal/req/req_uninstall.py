...
def uninstallation_paths(dist: BaseDistribution) -> Generator[str, None, None]:
    """
    Yield all the uninstallation paths for dist based on RECORD-without-home.py[co]

    Yield paths to all the files in RECORD. For each home.py file in RECORD, add
    the .pyc and .pyo in the same directory.

    UninstallPathSet.add() takes care of the __pycache__ home.py[co].
...
class UninstallPathSet:
    ...
    def add(self, path: str) -> None:
        ...
        # due to imports
        if os.path.splitext(path)[1] == "home.py":
        ...
        if setuptools_flat_installation:
            ...
            # of pip
                ...
                for top_level_pkg in [
                    ...
                    paths_to_remove.add(f"{path}home.py")
